...
11. The browser makes a [HTTP](https://www.cloudflare.com/learning/ddos/glossary/hypertext-transfer-protocol-http/) request to the IP address.
12. The server at that IP returns the webpage to be rendered in the browser (step 10).
![Diagram of 10 steps in DNS lookup and webpage query](https://cf-assets.www.cloudflare.com/slt3lc6tev37/54fXQrFHYvhAM7jIIpKEX7/8fb09ba9998d14862e80f5c9cc6d2170/complete-dns-lookup-and-webpage-query.png "Complete DNS lookup and webpage query")
