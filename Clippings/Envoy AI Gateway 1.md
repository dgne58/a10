...
source: "https://aigateway.envoyproxy.io/docs/"
author:
published:
created: 2026-04-13
description: "Welcome to the Envoy AI Gateway documentation! This open-source project, built on Envoy"
tags:
  - "clippings"
---
Version: latest
...
- **Enterprise-Grade Security Features**: Implement security controls including fine-grained access control, authorization policies, rate limiting, to access services, as well as ensure secure egress connection to external providers from the gateway via [Upstream Authentication](https://aigateway.envoyproxy.io/docs/capabilities/security/upstream-auth).
...
[Weekly community meetings](https://docs.google.com/document/d/10e1sfsF-3G3Du5nBHGmLjXw5GVMqqCvFDqp_O65B0_w) are held every Monday to discuss updates, address issues, and review contributions.
...
- Attend the [weekly community meetings](https://docs.google.com/document/d/10e1sfsF-3G3Du5nBHGmLjXw5GVMqqCvFDqp_O65B0_w) to stay updated and share ideas.
- Submit feature requests and pull requests via the GitHub repository.
- Join discussions in the [#envoy-ai-gateway](https://envoyproxy.slack.com/archives/C07Q4N24VAA) Slack channel.

Refer to [this contributing guide](https://github.com/envoyproxy/ai-gateway/blob/main/CONTRIBUTING.md) for detailed instructions on setting up your environment and contributing.
