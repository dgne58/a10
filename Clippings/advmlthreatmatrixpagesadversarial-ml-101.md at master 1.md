---
title: "advmlthreatmatrix/pages/adversarial-ml-101.md at master"
source: "https://github.com/mitre/advmlthreatmatrix/blob/master/pages/case-studies-page.md"
author:
published:
created: 2026-04-15
description: "Adversarial Threat Landscape for AI Systems. Contribute to mitre/advmlthreatmatrix development by creating an account on GitHub."
tags:
  - "clippings"
---
## Case Studies Page

- [Evasion of Deep Learning detector for malware C&C traffic](https://github.com/mitre/advmlthreatmatrix/blob/master/pages/case-studies-page.md#evasion-of-deep-learning-detector-for-malware-cc-traffic)
- [Botnet Domain Generation Algorithm (DGA) Detection Evasion](https://github.com/mitre/advmlthreatmatrix/blob/master/pages/case-studies-page.md#botnet-domain-generation-algorithm-dga-detection-evasion)
- [VirusTotal Poisoning](https://github.com/mitre/advmlthreatmatrix/blob/master/pages/case-studies-page.md#virustotal-poisoning)
- [Bypassing Cylance's AI Malware Detection](https://github.com/mitre/advmlthreatmatrix/blob/master/pages/case-studies-page.md#bypassing-cylances-ai-malware-detection)
- [Camera Hijack Attack on Facial Recognition System](https://github.com/mitre/advmlthreatmatrix/blob/master/pages/case-studies-page.md#camera-hijack-attack-on-facial-recognition-system)
- [Attack on Machine Translation Service - Google Translate, Bing Translator, and Systran Translate](https://github.com/mitre/advmlthreatmatrix/blob/master/pages/case-studies-page.md#attack-on-machine-translation-service---google-translate-bing-translator-and-systran-translate)
- [ClearviewAI Misconfiguration](https://github.com/mitre/advmlthreatmatrix/blob/master/pages/case-studies-page.md#clearviewai-misconfiguration)
- [GPT-2 Model Replication](https://github.com/mitre/advmlthreatmatrix/blob/master/pages/case-studies-page.md#gpt-2-model-replication)
- [ProofPoint Evasion](https://github.com/mitre/advmlthreatmatrix/blob/master/pages/case-studies-page.md#proofpoint-evasion)
- [Tay Poisoning](https://github.com/mitre/advmlthreatmatrix/blob/master/pages/case-studies-page.md#tay-poisoning)
- [Microsoft - Azure Service - Evasion](https://github.com/mitre/advmlthreatmatrix/blob/master/pages/case-studies-page.md#microsoft---azure-service)
- [Microsoft Edge AI - Evasion](https://github.com/mitre/advmlthreatmatrix/blob/master/pages/case-studies-page.md#microsoft---edge-ai)
- [MITRE - Physical Adversarial Attack on Face Identification](https://github.com/mitre/advmlthreatmatrix/blob/master/pages/case-studies-page.md#mitre---physical-adversarial-attack-on-face-identification)
...
[![](https://github.com/mitre/advmlthreatmatrix/raw/master/images/paloalto1.png)](https://github.com/mitre/advmlthreatmatrix/blob/master/images/paloalto1.png)
...
[![](https://github.com/mitre/advmlthreatmatrix/raw/master/images/paloalto2.png)](https://github.com/mitre/advmlthreatmatrix/blob/master/images/paloalto2.png)
...
- \[1\] Yu, Bin, Jie Pan, Jiaming Hu, Anderson Nascimento, and Martine De Cock. "Character level based detection of DGA domain names." In 2018 International Joint Conference on Neural Networks (IJCNN), pp. 1-8. IEEE, 2018. Source code is available from Github: [https://github.com/matthoffman/degas](https://github.com/matthoffman/degas)
...
[![](https://github.com/mitre/advmlthreatmatrix/raw/master/images/VirusTotal.png)](https://github.com/mitre/advmlthreatmatrix/blob/master/images/VirusTotal.png)
...
[![Cylance](https://github.com/mitre/advmlthreatmatrix/raw/master/images/cylance.png)](https://github.com/mitre/advmlthreatmatrix/blob/master/images/cylance.png)

**Reported by:** Research and work by Adi Ashkenazy, Shahar Zini, and SkyLight Cyber team. Notified to us by Ken Luu (@devianz\_)

**Source:**

- [https://skylightcyber.com/2019/07/18/cylance-i-kill-you/](https://skylightcyber.com/2019/07/18/cylance-i-kill-you/)
...
[![](https://github.com/mitre/advmlthreatmatrix/raw/master/images/FacialRecognitionANT.png)](https://github.com/mitre/advmlthreatmatrix/blob/master/images/FacialRecognitionANT.png)
...
[![](https://github.com/mitre/advmlthreatmatrix/raw/master/images/AttackOnMT.png)](https://github.com/mitre/advmlthreatmatrix/blob/master/images/AttackOnMT.png)
...
- [https://arxiv.org/abs/2004.15015](https://arxiv.org/abs/2004.15015)
- [https://www.ericswallace.com/imitation](https://www.ericswallace.com/imitation)
...
[![ClearviewAI](https://github.com/mitre/advmlthreatmatrix/raw/master/images/ClearviewAI.png)](https://github.com/mitre/advmlthreatmatrix/blob/master/images/ClearviewAI.png)

**Reported by:**

- Mossab Hussein (@mossab\_hussein)

**Source:**

- [https://techcrunch.com/2020/04/16/clearview-source-code-lapse/amp/](https://techcrunch.com/2020/04/16/clearview-source-code-lapse/amp/)
- [https://gizmodo.com/we-found-clearview-ais-shady-face-recognition-app-1841961772](https://gizmodo.com/we-found-clearview-ais-shady-face-recognition-app-1841961772)
...
- Next, they used a different publicly available NLP model (called Grover) and modified Grover's objective function to reflect GPT-2's objective function.
- The researchers then trained the modified Grover on the dataset they curated, using Grover's initial hyperparameters, which resulted in their replicated model.

[![GPT2_Replication](https://github.com/mitre/advmlthreatmatrix/raw/master/images/OpenAI.png)](https://github.com/mitre/advmlthreatmatrix/blob/master/images/OpenAI.png)
...
- [https://www.wired.com/story/dangerous-ai-open-source/](https://www.wired.com/story/dangerous-ai-open-source/)
...
[![PFPT_Evasion](https://github.com/mitre/advmlthreatmatrix/raw/master/images/ProofPoint.png)](https://github.com/mitre/advmlthreatmatrix/blob/master/images/ProofPoint.png)
...
- [https://nvd.nist.gov/vuln/detail/CVE-2019-20634](https://nvd.nist.gov/vuln/detail/CVE-2019-20634)
...
[![Tay_Poisoning](https://github.com/mitre/advmlthreatmatrix/raw/master/images/Tay.png)](https://github.com/mitre/advmlthreatmatrix/blob/master/images/Tay.png)
...
- [https://spectrum.ieee.org/tech-talk/artificial-intelligence/machine-learning/in-2016-microsofts-racist-chatbot-revealed-the-dangers-of-online-conversation](https://spectrum.ieee.org/tech-talk/artificial-intelligence/machine-learning/in-2016-microsofts-racist-chatbot-revealed-the-dangers-of-online-conversation)
...
**Reported by:** Microsoft **Mapping to Adversarial Threat Matrix:**
...
[![MS_Azure](https://github.com/mitre/advmlthreatmatrix/raw/master/images/Msft1.PNG)](https://github.com/mitre/advmlthreatmatrix/blob/master/images/Msft1.PNG)
...
[![alt_text](https://github.com/mitre/advmlthreatmatrix/raw/master/images/msft2.png)](https://github.com/mitre/advmlthreatmatrix/blob/master/images/msft2.png)
...
[![mitre](https://github.com/mitre/advmlthreatmatrix/raw/master/images/mitre.png)](https://github.com/mitre/advmlthreatmatrix/blob/master/images/mitre.png)
...
You can email [advmlthreatmatrix-core@googlegroups.com](mailto:advmlthreatmatrix-core@googlegroups.com) with summary of the incident, Adversarial ML Threat Matrix mapping and associated resources.