---
title: "Terminology — envoy 1.38.0-dev-550d57 documentation"
source: "https://www.envoyproxy.io/docs/envoy/latest/intro/arch_overview/intro/terminology"
author:
published:
created: 2026-04-15
description:
...
**Cluster**: A cluster is a group of logically similar upstream hosts that Envoy connects to. Envoy discovers the members of a cluster via [service discovery](https://www.envoyproxy.io/docs/envoy/latest/intro/arch_overview/upstream/service_discovery#arch-overview-service-discovery). It optionally determines the health of cluster members via [active health checking](https://www.envoyproxy.io/docs/envoy/latest/intro/arch_overview/upstream/health_checking#arch-overview-health-checking). The cluster member that Envoy routes a request to is determined by the [load balancing policy](https://www.envoyproxy.io/docs/envoy/latest/intro/arch_overview/upstream/load_balancing/overview#arch-overview-load-balancing).
