---
title: "What is Istio?"
source: "https://istio.io/latest/docs/overview/what-is-istio/"
author:
published:
created: 2026-04-15
...
Istio is designed for extensibility and can handle a diverse range of deployment needs. Istio’s control plane runs on Kubernetes, and you can add applications deployed in that cluster to your mesh, [extend the mesh to other clusters](https://istio.io/latest/docs/ops/deployment/deployment-models/), or even [connect VMs or other endpoints](https://istio.io/latest/docs/ops/deployment/vm-architecture/) running outside of Kubernetes.

A large ecosystem of contributors, partners, integrations, and distributors extend and leverage Istio for a wide variety of scenarios. You can install Istio yourself, or a [large number of vendors](https://istio.io/latest/about/ecosystem/) have products that integrate Istio and manage it for you.
...
[Learn how to choose which mode is right for you](https://istio.io/latest/docs/overview/dataplane-modes/).