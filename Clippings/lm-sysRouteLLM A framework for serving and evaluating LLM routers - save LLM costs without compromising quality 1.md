---
title: "lm-sys/RouteLLM: A framework for serving and evaluating LLM routers - save LLM costs without compromising quality"
source: "https://github.com/lm-sys/RouteLLM"
author:
published:
created: 2026-04-15
description: "A framework for serving and evaluating LLM routers - save LLM costs without compromising quality - lm-sys/RouteLLM"
tags:
  - "clippings"
---
## RouteLLM
...
[![](https://github.com/lm-sys/RouteLLM/raw/main/assets/router.png)](https://github.com/lm-sys/RouteLLM/blob/main/assets/router.png)
...
Want to route to local models? Check out [Routing to Local Models](https://github.com/lm-sys/RouteLLM/blob/main/examples/routing_to_local_models.md).
...
1. Now, let's update the `model` field when we generate completions to specify the router and threshold to use:
```
...
[![](https://github.com/lm-sys/RouteLLM/raw/main/assets/chat-interface.png)](https://github.com/lm-sys/RouteLLM/blob/main/assets/chat-interface.png)
...
- Local models with Ollama: see [this guide](https://github.com/lm-sys/RouteLLM/blob/main/examples/routing_to_local_models.md)
