...
<iframe allow="clipboard-write" src="https://n8n-preview-service.internal.n8n.cloud/workflows/demo"></iframe>[View workflow file](https://docs.n8n.io/_workflows//courses/level-one/chapter-2.json)

## 1\. Add a Manual Trigger node

Open the nodes panel (reminder: you can open this by selecting the **+** icon in the top right corner of the [canvas](https://docs.n8n.io/glossary/#canvas-n8n) or pressing N on your keyboard).
