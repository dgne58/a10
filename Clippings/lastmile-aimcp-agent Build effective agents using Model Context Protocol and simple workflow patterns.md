---
title: "lastmile-ai/mcp-agent: Build effective agents using Model Context Protocol and simple workflow patterns"
...
tags:
  - "clippings"
---
[![Logo](https://private-user-images.githubusercontent.com/25641935/451110683-c8d059e5-bd56-4ea2-a72d-807fb4897bde.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..iTvKlUWFPVlOQhMnNkhIqEpW925veqGOk9cC0ixv0yE)](https://docs.mcp-agent.com/)
...
[![lastmile-ai%2Fmcp-agent | Trendshift](https://camo.githubusercontent.com/9e05e8c6b0b2e72ba6a48134d737fb52cec6169efcc32030f7f3c19fcb986fb4/68747470733a2f2f7472656e6473686966742e696f2f6170692f62616467652f7265706f7369746f726965732f3133323136)](https://trendshift.io/repositories/13216)
...
| ### Build an Agent  Connect LLMs to MCP servers in simple, composable patterns like map-reduce, orchestrator, evaluator-optimizer, router & more.  [Quick Start ↗](https://docs.mcp-agent.com/get-started/overview) \| [Docs ↗](https://docs.mcp-agent.com/mcp-agent-sdk/overview) | ### Create any kind of MCP Server  Create MCP servers with a FastMCP-compatible API. You can even expose agents as MCP servers.  [MCP Agent Server ↗](https://docs.mcp-agent.com/mcp-agent-sdk/mcp/agent-as-mcp-server) \| [🎨 Build a ChatGPT App ↗](https://docs.mcp-agent.com/cloud/use-cases/deploy-chatgpt-apps) \| [Examples ↗](https://github.com/lastmile-ai/mcp-agent/tree/main/examples/mcp_agent_server) |
| --- | --- | --- | --- | --- |
| ### Full MCP Support  **Core:** Tools ✅ Resources ✅ Prompts ✅ Notifications ✅   **Advanced**: OAuth ✅ Sampling ✅ Elicitation ✅ Roots ✅  [Examples ↗](https://github.com/lastmile-ai/mcp-agent/tree/main/examples/mcp) \| [MCP Docs ↗](https://modelcontextprotocol.io/docs/getting-started/intro) | ### Durable Execution (Temporal)  Scales to production workloads using Temporal as the agent runtime backend *without any API changes*.  [Docs ↗](https://docs.mcp-agent.com/mcp-agent-sdk/advanced/durable-agents) \| [Examples ↗](https://github.com/lastmile-ai/mcp-agent/tree/main/examples/temporal) |
| ### ☁️ Deploy to Cloud  **Beta:** Deploy agents yourself, or use **mcp-c** for a managed agent runtime. All apps are deployed as MCP servers.  [Demo ↗](https://www.youtube.com/watch?v=0C4VY-3IVNU) \| [Cloud Quickstart ↗](https://docs.mcp-agent.com/get-started/cloud) \| [Examples ↗](https://github.com/lastmile-ai/mcp-agent/tree/main/examples/cloud) |
...
```
Agent output [![Image](https://private-user-images.githubusercontent.com/25641935/407786779-eaa60fdf-bcc6-460b-926e-6fa8534e9089.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..8nqJHBu-2lpDJdWEXF474rAaaTb5aZB_CvLrXBtPlp4)](https://private-user-images.githubusercontent.com/25641935/407786779-eaa60fdf-bcc6-460b-926e-6fa8534e9089.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..8nqJHBu-2lpDJdWEXF474rAaaTb5aZB_CvLrXBtPlp4) 
...
| --- | --- | --- | --- |
| Parallel (Map-Reduce) | `create_parallel_llm(...)` | Fan-out specialists and fan-in aggregated reports.   [![](https://camo.githubusercontent.)](https://www.anthropic.com/_next/image?url=https%3A%2F%2Fwww-cdn.anthropic.com%2Fimages%2F4zrzovbb%2Fwebsite%2F406bb032ca007fd1624f261af717d70e6ca86286-2401x1000.png&w=3840&q=75) | [Parallel](https://docs.mcp-agent.com/mcp-agent-sdk/effective-patterns/map-reduce) |
| Router | `create_router_llm(...)` / `create_router_embedding(...)` | Route requests to the best agent, server, or function.   [![](https://camo.githubusercontent.)](https://www.anthropic.com/_next/image?url=https%3A%2F%2Fwww-cdn.anthropic.com%2Fimages%2F4zrzovbb%2Fwebsite%2F5c0c0e9fe4def0b584c04d37849941da55e5e71c-2401x1000.png&w=3840&q=75) | [Router](https://docs.mcp-agent.com/mcp-agent-sdk/effective-patterns/router) |
...
| Evaluator-optimizer | `create_evaluator_optimizer_llm(...)` | Iterate until an evaluator approves the result.   [![](https://camo.githubusercontent.)](https://www.anthropic.com/_next/image?url=https%3A%2F%2Fwww-cdn.anthropic.com%2Fimages%2F4zrzovbb%2Fwebsite%2F14f51e6406ccb29e695da48b17017e899a6119c7-2401x1000.png&w=3840&q=75) | [Evaluator-optimizer](https://docs.mcp-agent.com/mcp-agent-sdk/effective-patterns/evaluator-optimizer) |
| Swarm | `create_swarm(...)` | Multi-agent handoffs compatible with OpenAI Swarm.   [![](https://github.com/openai/swarm/raw/main/assets/swarm_diagram.png?raw=true)](https://github.com/openai/swarm/blob/main/assets/swarm_diagram.png?raw=true) | [Swarm](https://docs.mcp-agent.com/mcp-agent-sdk/effective-patterns/swarm) |
...
Docs: [Workflow composition](https://docs.mcp-agent.com/mcp-agent-sdk/advanced/composition) • Examples: [`examples/basic/agent_factory`](https://github.com/lastmile-ai/mcp-agent/blob/main/examples/basic/agent_factory).
...
Resume with `mcp-agent cloud workflows resume … --payload '{"content": "approve"}'`. Docs: [Deploy agents – human input](https://docs.mcp-agent.com/cloud/use-cases/deploy-agents#human-in-the-loop-patterns) • Examples: [`examples/human_input/temporal`](https://github.com/lastmile-ai/mcp-agent/blob/main/examples/human_input/temporal).
...
Docs: [`MCPApp` icons](https://docs.mcp-agent.com/mcp-agent-sdk/core-components/mcpapp#icons) • Examples: [`examples/mcp_agent_server/asyncio`](https://github.com/lastmile-ai/mcp-agent/blob/main/examples/mcp_agent_server/asyncio).
...
Docs: [Connecting to MCP servers](https://docs.mcp-agent.com/mcp-agent-sdk/core-components/connecting-to-mcp-servers) • Examples: [`examples/basic/mcp_server_aggregator`](https://github.com/lastmile-ai/mcp-agent/blob/main/examples/basic/mcp_server_aggregator).
...
Docs: [Cloud overview](https://docs.mcp-agent.com/cloud/overview) • [Deployment quickstart](https://docs.mcp-agent.com/cloud/deployment-quickstart) • Examples: [`examples/cloud`](https://github.com/lastmile-ai/mcp-agent/blob/main/examples/cloud).

## Examples

Browse [gallery.md](https://github.com/lastmile-ai/mcp-agent/blob/main/gallery.md) for runnable examples, demo videos, and community projects grouped by concept. Every entry cites the docs page and command you need to run it locally.
...
We welcome contributions of every size—bug fixes, new examples, docs, or feature requests. Start with [CONTRIBUTING.md](https://github.com/lastmile-ai/mcp-agent/blob/main/CONTRIBUTING.md), open a discussion, or drop by [Discord](https://lmai.link/discord/mcp-agent).

mcp-agent would not be possible without the tireless efforts of the many open source contributors. Thank you!

[![Contributor faces](https://camo.githubusercontent.com/8761b264aa04c37931ba8ef6a5753ed069f2a19d154fe2de727b291095c92ff3/68747470733a2f2f636f6e747269622e726f636b732f696d6167653f7265706f3d6c6173746d696c652d61692f6d63702d6167656e74)](https://github.com/lastmile-ai/mcp-agent/graphs/contributors)