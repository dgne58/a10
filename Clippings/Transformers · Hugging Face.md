...
Explore the [Models Timeline](https://huggingface.co/docs/transformers/en/models_timeline) to discover the latest text, vision, audio and multimodal model architectures in Transformers.

## Features

Transformers provides everything you need for inference or training with state-of-the-art pretrained models. Some of the main features include:

- [Pipeline](https://huggingface.co/docs/transformers/en/pipeline_tutorial): Simple and optimized inference class for many machine learning tasks like text generation, image segmentation, automatic speech recognition, document question answering, and more.
- [Trainer](https://huggingface.co/docs/transformers/en/trainer): A comprehensive trainer that supports features such as mixed precision, torch.compile, and FlashAttention for training and distributed training for PyTorch models.
- [generate](https://huggingface.co/docs/transformers/en/llm_tutorial): Fast text generation with large language models (LLMs) and vision language models (VLMs), including support for streaming and multiple decoding strategies.

## Design

> Read our [Philosophy](https://huggingface.co/docs/transformers/en/philosophy) to learn more about Transformers’ design principles.

Transformers is designed for developers and machine learning engineers and researchers. Its main design principles are:

1. Fast and easy to use: Every model is implemented from only three main classes (configuration, model, and preprocessor) and can be quickly used for inference or training with [Pipeline](https://huggingface.co/docs/transformers/v5.5.4/en/main_classes/pipelines#transformers.Pipeline) or [Trainer](https://huggingface.co/docs/transformers/v5.5.4/en/main_classes/trainer#transformers.Trainer).
...
[Installation→](https://huggingface.co/docs/transformers/en/installation)