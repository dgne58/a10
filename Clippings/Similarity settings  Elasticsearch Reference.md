---
title: "Similarity settings | Elasticsearch Reference"
source: "https://www.elastic.co/docs/reference/elasticsearch/index-settings/similarity"
author:
published:
created: 2026-04-15
description: "A similarity (scoring / ranking model) defines how matching documents are scored. Similarity is per field, meaning that via the mapping one can define..."
tags:
  - "clippings"
---
## Similarity settings
...
Configuring a custom similarity is considered an expert feature and the builtin similarities are most likely sufficient as is described in [`similarity`](https://www.elastic.co/docs/reference/elasticsearch/mapping-reference/similarity).
...
TF/IDF based similarity that has built-in tf normalization and is supposed to work better for short fields (like names). See [Okapi\_BM25](https://en.wikipedia.org/wiki/Okapi_BM25) for more details. This similarity has the following options:
