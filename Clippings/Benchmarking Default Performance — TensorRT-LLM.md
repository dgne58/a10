---
title: "Benchmarking Default Performance — TensorRT-LLM"
source: "https://nvidia.github.io/TensorRT-LLM/performance/performance-tuning-guide/benchmarking-default-performance.html#benchmarking-with-trtllm-bench"
author:
published:
created: 2026-04-15
description:
...
The README in the examples folder for supported models walks through building engines using this flow for a wide variety of situations. The examples folder for Llama models can be found at [NVIDIA/TensorRT-LLM](https://github.com/NVIDIA/TensorRT-LLM/tree/main/examples/models/core/llama).
...
`trtllm-bench` can also take in real data, see [`trtllm-bench` documentation](https://nvidia.github.io/TensorRT-LLM/performance/perf-benchmarking.html) for more details on the required format.
