...
source: "https://github.com/mitre/advmlthreatmatrix/blob/master/pages/adversarial-ml-101.md"
author:
published:
created: 2026-04-15
...
[![Adversarial ML 101](https://github.com/mitre/advmlthreatmatrix/raw/master/images/AdvML101.PNG)](https://github.com/mitre/advmlthreatmatrix/blob/master/images/AdvML101.PNG)
...
[![Adversarial ML 101](https://github.com/mitre/advmlthreatmatrix/raw/master/images/AdvML101_Inference.PNG)](https://github.com/mitre/advmlthreatmatrix/blob/master/images/AdvML101_Inference.PNG)

---

## Attack Scenario #2: Training Time Attack

Consider that an attacker has control over training data. This flavor of attack is shown in [Tay Poisoning Case Study](https://github.com/mitre/advmlthreatmatrix/blob/master/pages/case-studies-page.md#tay-poisoning) where the attacker was able to compromise the training data via the feedback mechanism.

[![Adversarial ML 101](https://github.com/mitre/advmlthreatmatrix/raw/master/images/AdvML101_Traintime.PNG)](https://github.com/mitre/advmlthreatmatrix/blob/master/images/AdvML101_Traintime.PNG)

## Attack Scenario #3: Attack on Edge/Client

Consider that a model exists on a client (like a phone) or on the edge (such as IoT). An attacker might have access to model code through reversing the service on the client. This flavor of attack is shown in [Bosch Case Study with EdgeAI](https://github.com/mitre/advmlthreatmatrix/blob/master/pages/case-studies-page.md#bosch---edge-ai).

[![Adversarial ML 101](https://github.com/mitre/advmlthreatmatrix/raw/master/images/AdvML101_Client.PNG)](https://github.com/mitre/advmlthreatmatrix/blob/master/images/AdvML101_Client.PNG)
...
Head over to [Adversarial ML Threat Matrix](https://github.com/mitre/advmlthreatmatrix/blob/master/pages/adversarial-ml-threat-matrix.md#adversarial-ml-threat-matrix) page to see a compendium of attacks in ATT&CK style.