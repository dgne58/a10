---
title: "What is the network layer? | Network vs. Internet layer"
source: "https://www.cloudflare.com/learning/network-layer/what-is-the-network-layer/"
author:
published:
created: 2026-04-15
description: "The network layer is layer 3 in the OSI model, and it makes the Internet possible by connecting different networks. It is also called the Internet layer."
tags:
  - "clippings"
---
Preview Mode
...
- Understand what processes occur at the network layer
- Contrast the OSI model network layer with the TCP/IP model Internet layer

Copy article link

## What is the network layer?

![The Network Layer](https://www.cloudflare.com/resources/images/slt3lc6tev37/5ixfRhqidLTnJO3hpkmxjE/b2653080e575173f0844e3e294bec6d9/what-is-the-network-layer.png)
...
In the 7-layer [OSI model](https://www.cloudflare.com/learning/ddos/glossary/open-systems-interconnection-model-osi/) (see below), the network layer is layer 3. The [Internet Protocol (IP)](https://www.cloudflare.com/learning/ddos/glossary/internet-protocol/) is one of the main protocols used at this layer, along with several other protocols for [routing](https://www.cloudflare.com/learning/network-layer/what-is-routing/), testing, and [encryption](https://www.cloudflare.com/learning/ssl/what-is-encryption/).
...
A network is a group of two or more connected computing devices. Usually all devices in the network are connected to a central hub — for instance, a [router](https://www.cloudflare.com/learning/network-layer/what-is-a-router/). A network can also include [subnetworks](https://www.cloudflare.com/learning/network-layer/what-is-a-subnet/), or smaller subdivisions of the network. Subnetworking is how very large networks, such as those provided by ISPs, are able to manage thousands of IP addresses and connected devices.
...
In other words, the network layer and the Internet layer are basically the same thing, but they come from different models of [how the Internet works](https://www.cloudflare.com/learning/network-layer/how-does-the-internet-work/).
...
Because they are exposed to the rest of the Internet, network layer infrastructure is vulnerable to external attacks, especially [distributed denial-of-service (DDoS) attacks](https://www.cloudflare.com/learning/ddos/what-is-a-ddos-attack/). Routers, switches, and other network interfaces can all be overwhelmed or compromised by malicious network traffic, and almost any of the above network protocols can be used in an attack.

[Cloudflare Magic Transit](https://www.cloudflare.com/magic-transit/) protects [networking infrastructure](https://www.cloudflare.com/the-net/network-infrastructure/) using the same technology that keeps millions of web properties up and running in the face of vulnerability exploits and DDoS attacks. It extends the protection of Cloudflare to on-premise and data center networks, keeping organizations secure from [network layer attacks](https://www.cloudflare.com/learning/ddos/layer-3-ddos-attacks/).