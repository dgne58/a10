---
title: "JSON Schema - Specification [#section]"
...
The latest meta-schema is **2020-12**. For an explanation of the change to date-based identifiers, see the [Specification Links](https://json-schema.org/specification-links) page.
...
Please see [Specification Links](https://json-schema.org/specification-links) for older drafts and the latest unreleased version of the specification.
...
[Edit this page on Github](https://github.com/json-schema-org/website/blob/main/pages/specification.md)
