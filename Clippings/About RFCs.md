---
title: "About RFCs"
source: "https://www.ietf.org/process/rfcs/"
author:
published:
created: 2026-04-13
description: "RFC documents contain technical specifications and organizational notes for the Internet and are the core output of the IETF."
tags:
  - "clippings"
---
...
- [Structure of the series](#series-structure)
- [Availability and use](#availability-and-use)
- [Publication formats](#formats)
- [Statuses](#statuses)
- [Publication streams](#streams)
- [Obsoleting and updating](#obsoleting-and-updating)
- [Corrections and errata](#errata)
- [Reporting vulnerabilities in RFCs](#vulnerabilities)
...
The Editorial Stream, as described by [RFC 9920](https://www.rfc-editor.org/rfc/rfc9920.html) publishes policies governing the RFC Series as a whole.
