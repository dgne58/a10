...
- The system is intentionally narrow: branch routing, local memory, and visible traces instead of a sprawling "AI platform" story.
...
- one memory-first project/codebase example with a local source
